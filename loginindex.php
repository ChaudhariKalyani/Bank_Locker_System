...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <a href="loginindex.php" class="get-started-btn scrollto">LOGIN / SIGN UP&nbsp;</a>
    </div>
  </header><!-- End Header -->
 <!-- ======= Hero Section ======= -->
...
<body>
<form name=frm method=post action=loginindex.php>
    <center>
...
?>
    ...
    <!-- <a href="loginindex.php" class="btn-get-started scrollto">LOGIN / SIGN UP</a>-->
    </div>
  </div>
</div>
