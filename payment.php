...
if(empty($_POST['ra']))
{
$err2="<font color='red'>*Rate must exist";
$fl=1;
}
if(empty($_POST['pno']))
{
$err3="<font color='red'>*Payment Number exist";
$fl=1;
}
if(empty($_POST['pd']))
{
$err4="<font color='red'>*Pay Date must exist";
$fl=1;
}
if(empty($_POST['am']))
{
$err5="<font color='red'>*Amount must exist";
$fl=1;
}
if(empty($_POST['vno']))
{
$err6="<font color='red'>*Voucher Number must exist";
$fl=1;
}
if(empty($_POST['cn']))
{
$err7="<font color='red'>*CHDD Number must exist";
$fl=1;
}
if(empty($_POST['cd']))
{
$err8="<font color='red'>*CHDD Date must exist";
$fl=1;
}
}
}
...
<html>
    ...
    <center>  
        ...
        <caption><h2>PAYMENT INFORMATION</h2></caption> </br>  
        <table> 
        ...
        <tr>
            ...
            <tr>
                ...
                <td><input type="number" name=ra maxlength="10" onkeypress="return valid1()"><?php echo $err2;?></br></td>
            </tr>

            <tr>
                <td style="color:white">Payment Number</td>
                <td><input type="number" name=pno maxlength="10" onkeypress="return valid1()"><?php echo $err3;?></br></td>  
            </tr>


            <tr>
                <td style="color:white">Pay Date</td>
                <td><input type="date" name=pd ><?php echo $err4;?></br></td>
            </tr>

            <tr>
                <td style="color:white">Amount</td>
                <td><input type="number" name=am onkeypress=" return valid1()"><?php echo $err5;?></br></td>
            </tr>

            <tr>
                <td style="color:white">Voucher Number</td>
                <td><input type="number" name=vno maxlength="10" onkeypress="return valid1()"><?php echo $err6;?></br></td>
            </tr>

            <tr>
                <td style="color:white">CHDD Number</td>
                <td><input type="number" name=cn onkeypress="return valid1()"><?php echo $err7;?></br></td>
            </tr>

            <tr>
                <td style="color:white">CHDD Date</td>
                <td><input type="date" name="cd" ><?php echo $err8;?></br></td>
            </tr>
...
if($sb=="Submit")
{
    if($fl==0)   
{
$sql="insert into payment values('$_POST[ci]','$_POST[no]','$_POST[ra]','$_POST[pno]','$_POST[pd]','$_POST[am]','$_POST[vno]','$_POST[cn]','$_POST[cd]')";
mysql_query($sql,$cn);
echo "data stored";
}
}
...
if($sb=="Update")
{
    if($fl==0)
{
$sql="update payment set lockernumber='$_POST[no]',rate='$_POST[ra]', payment='$_POST[pno]',paydate='$_POST[pd]',amount='$_POST[am]',vouchernumber='$_POST[vno]',chddnumber='$_POST[cn]',chdddate='$_POST[cd]'where customerid='$_POST[ci]'";
mysql_query($sql,$cn);
echo "data updated";
}
}
...
if($sb=="Delete")
{
$sql="delete from payment  where customerid='$_POST[ci]'";
mysql_query($sql,$cn);
echo "data deleted";
}
else
...
echo "<th>rate</th>";
echo "<th>paymentnumber</th>";
echo "<th>paydate</th>";
echo "<th>amount</th>";
echo "<th>vouchernumber</th>";
echo "<th>chddnumber</th>";
echo "<th>chdddate</th>";
echo "</tr>";
...
echo "<th>chdddate</th>";
echo "</tr>";
$sql="select * from payment where lockernumber='$_POST[no]'";
$result=mysql_query($sql,$cn);
while($row=mysql_fetch_array($result))
{
echo "<tr>";
